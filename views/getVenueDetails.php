...
<body ng-app="venueApp" ng-controller="venueCtrl">
	...
	<div class="content" style="margin-top: 120px; padding: 50px;">
		...
		<span hidden="true" id="categoryDiv"><?=$arr['category']?></span>
		<div class="row">
			<div class="col-md-4">
		...
		<div class="row" style="color: black;">
		  ...
		  <br><br>
		  <div class="col-md-12" style="overflow: scroll; height: 500px;border-style: solid; background: #EBEAEA;">
	        ...
	        <div ng-repeat="dest in destination_details" >
	        	<div class="col-md-3">
	        	  <div class="card">
	        	    <img class="card-img-top" src='<?=$image_base_url."?name={{dest.photo}}&width=800&height=550"?>' alt="Card image cap" style="background: white;">
	        	    <div class="card-block cardDiv" style="background: white;">
